...
/**
 * Test class for MautServiceImplDao (DAO Pattern implementation)
 * Tests the same scenarios as MautServiceTest but with DAO pattern
 *
 * @author Generated for Exercise 3
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class MautServiceDaoTest {
    private static final Logger L = LoggerFactory.getLogger(MautServiceDaoTest.class);
